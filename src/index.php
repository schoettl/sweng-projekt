...
<html>
    <head>
        ...
        <title>sweng-projekt: Startseite</title>
    </head>
    <body>
        <h1>Startseite</h1>
        ...
        <ul>
            ...
            <li><a href="sim/" target="_blank">Zur Simulation: Seiten zur Simulation von Zugangs-/Buchungssystem, Schlüssel, Schloss und Programmiervorgängen</a></li>
        </ul>
    </body>
</html>
